...
function sideEffectsMapper(window, document) {
	const sideEffects = {
		document: {
			addEventListener: {
...
// BeforeAll
function createEventListenerSpy(sideEffects) {
...
// BeforeEach
function resetJSDOM(document, sideEffects) {
...
export { sideEffectsMapper, createEventListenerSpy, resetJSDOM };
