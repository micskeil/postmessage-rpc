...
# Run examples (requires static server)
npm install -g static-server
static-server -c "*" -zp 8080
# Then open http://localhost:8080/examples/content-editor-example.html
```
...
- `CustomEventListener<T, U>`: Listener with callback, options, and message channel
